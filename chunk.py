...
def render_and_save(chunkfile, cachedir, worldobj, oldimg, initial=False, queue=None, force=False):
...
class ChunkRenderer(object):
    ...
    def render_and_save(self, initial=False, force=False):
        ...
        if self.oldimg:
            if not force and dest_filename == self.oldimg:
